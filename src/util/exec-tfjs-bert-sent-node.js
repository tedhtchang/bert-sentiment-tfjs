...
// const model = await tf.loadGraphModel('http://localhost:3000/model/model.json'); //var
 const model = await tf.loadGraphModel('http://localhost:3000/model/model.json'); //var
//const model = await tf.loadGraphModel('https://storage.googleapis.com/learnjs-data/bert_tfjs_tokens/model.json'); //var
...
const layer = await model.execute({'segment_ids_1': segment_ids, 'input_ids_1': input_ids, 'input_mask_1': input_mask},
                                  'loss/Softmax');
